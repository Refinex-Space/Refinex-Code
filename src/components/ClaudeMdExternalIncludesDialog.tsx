...
export function ClaudeMdExternalIncludesDialog(t0) {
  ...
  if ($[5] === Symbol.for("react.memo_cache_sentinel")) {
    t6 = <Text>This project's AGENTS.md or legacy CLAUDE.md imports files outside the current working directory. Never allow this for third-party repositories.</Text>;
    $[5] = t6;
  } else {
    t6 = $[5];
  }
  ...
  if ($[12] !== handleEscape || $[13] !== t10 || $[14] !== t4 || $[15] !== t5 || $[16] !== t7) {
    t11 = <Dialog title="Allow external AGENTS.md / CLAUDE.md file imports?" color="warning" onCancel={handleEscape} hideBorder={t4} hideInputGuide={t5}>{t6}{t7}{t8}{t10}</Dialog>;
    $[12] = handleEscape;
    $[13] = t10;
    $[14] = t4;
    $[15] = t5;
