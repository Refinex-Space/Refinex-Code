...
> Summary: Switched new thread default conversation mode from TUI to GUI with updated smoke coverage
> Duration: same day
> Key learnings: default mode should be asserted explicitly in smoke tests to avoid hidden fallback regressions
...
- **Scope**: desktop renderer 线程模式默认值与相关回归测试
- **Non-goals**: 不改 IPC 协议、不移除 TUI 能力、不改已有手动模式切换交互
- **Rollback**: Git revert or restore the modified files
- **Roadmap entry**: `docs/PLANS.md`
- **Plan path**: `docs/exec-plans/completed/2026-04-08-default-new-thread-to-gui.md`
...
- Archived via harness-feat script with deterministic `docs/PLANS.md` resync.
