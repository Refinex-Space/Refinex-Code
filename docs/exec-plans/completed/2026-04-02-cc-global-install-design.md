> Archived companion design for `2026-04-02-cc-global-install.md`.
> Migrated from `docs/superpowers/specs/2026-04-02-cc-global-install-design.md` during Harness migration on 2026-04-05.
